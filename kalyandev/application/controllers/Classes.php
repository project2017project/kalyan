...
class Classes extends MY_Controller {
...

	{
		...
		$data['page_classes'] = $this->Model_common->all_page_classes();
		...
		$data['classess'] = $this->Model_classes->all_classes();

		$data['portfolio_footer'] = $this->Model_portfolio->get_portfolio_data();



		$data['check_captcha'] = $this->Model_classes->check_captcha();

		$data['total_captcha'] = $this->Model_classes->total_captcha();
