					...
					<div class="box-body">						
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<input type="text" autocomplete="off" class="form-control" name="meta_title" value="<?php echo $classes['meta_title']; ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<textarea class="form-control" name="meta_keyword" style="height:80px;"><?php echo $classes['meta_keyword']; ?></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<textarea class="form-control" name="meta_description" style="height:80px;"><?php echo $classes['meta_description']; ?></textarea>
