...
(function ($) {
	...
	windowOn.on('load', function () {
		...
		if ($('.tp-testimonial-active').length > 0) {
			var slider = new Swiper('.tp-testimonial-active', {
				...
				breakpoints: {
					...
					// Navigation arrows
					navigation: {
						nextEl: ".test-button-next-1",
						prevEl: ".test-button-prev-1",
					},
				});
			}
		...
		if ($('.tp-countries-active').length > 0) {
			var slider = new Swiper('.tp-countries-active', {
				...
				breakpoints: {
					...
					// Navigation arrows
					navigation: {
						nextEl: ".visacat-button-prev-1",
						prevEl: ".visacat-button-next-1",
					},
		...
		// team Active
			...
			////////////////////////////////////////////////////
		// team Active
		if ($('.tp-countries-about-active').length > 0) {
			var slider = new Swiper('.tp-countries-about-active', {
				slidesPerView: 5,
				spaceBetween: 30,
				autoplay:true,
				loop: true,
		...
		// team Active
			...
			////////////////////////////////////////////////////
		// visa Active
		if ($('.tp-visa-active').length > 0) {
			var slider = new Swiper('.tp-visa-active', {
				slidesPerView: 4,
				spaceBetween: 30,
				loop: true,
				breakpoints: {
		...
		// visa Active
				...
				////////////////////////////////////////////////////
		// visa Active
		if ($('.tp-visa-category-active').length > 0) {
			var slider = new Swiper('.tp-visa-category-active', {
				slidesPerView: 3,
				spaceBetween: 45,
				loop: true,
				breakpoints: {
		...
		// visa Active
					...
					////////////////////////////////////////////////////
		// visa Active
		if ($('.tp-videos-active').length > 0) {
			var slider = new Swiper('.tp-videos-active', {
				slidesPerView: 4,
				spaceBetween: 25,
				loop: true,
				breakpoints: {
		...
		// visa Active
					...
					////////////////////////////////////////////////////
		// Training Start
		if ($('.tp-training-class-active').length > 0) {
			var slider = new Swiper('.tp-training-class-active', {
				slidesPerView: 4,
				spaceBetween: 30,
				loop: true,
				breakpoints: {
